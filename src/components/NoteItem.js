            ...
            <Dialog open={open} onClose={handleClose} >
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <DialogActions>
                        ...
                        <Button disabled={title.length < 3 || description.length < 3 || tag.length < 3 } variant="contained" color="secondary" type="submit" onClick={handleClose} style={{ textTransform: "none", fontFamily: "'Poppins', sans-serif", fontSize: "1rem" }}>Edit</Button>
                    </DialogActions>
                </form>
            </Dialog>
